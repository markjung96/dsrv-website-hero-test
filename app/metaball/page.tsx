...
import MetaballBackground, { type MetaballVariant } from "../components/MetaballBackground";
import VersionSelector from "../components/VersionSelector";

const heroes: { variant: MetaballVariant; title: string; subtitle: string }[] = [
...
export default function MetaballPage() {
  ...
  return (
    <main className="relative h-screen overflow-hidden bg-white">
      <MetaballBackground key={variant} variant={variant} />
